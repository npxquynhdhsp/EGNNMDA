...
def combine2(mi_em1, dis_em1, mi_em2, dis_em2, idx_pair_train, idx_pair_test, loop_i, ix):
    ...
    mi_em1T = (mi_em1 - mi_em1.min()) / (mi_em1.max() - mi_em1.min())
    mi_em2T = (mi_em2 - mi_em2.min()) / (mi_em2.max() - mi_em2.min())
    dis_em1T = (dis_em1 - dis_em1.min()) / (dis_em1.max() - dis_em1.min())
    dis_em2T = (dis_em2 - dis_em2.min()) / (dis_em2.max() - dis_em2.min())
