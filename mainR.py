...
def main():
    ...
    for loop_i in range(args.bgl, args.nloop + 1):
        ...
        for ix in set_ix:
            ...
            y_prob1 = models_eval(method_set[0] + '_RandomMCB', X_train1, X_test1, y_train, y_test, ix, loop_i, 1)
            X_train2, y_trainR = balance_data(X_train2T, y_trainT, 1)
            y_prob2 = models_eval(method_set[0] + '_RandomMCB', X_train2, X_test2, y_train, y_test, ix, loop_i, 2)
            ...
            print('BOTH:')
            log_loss_1 = log_loss(y_test, y_prob1)
            log_loss_2 = log_loss(y_test, y_prob2)
